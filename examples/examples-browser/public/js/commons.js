...
function renderNavBar(navbarId, exampleUri) {
  const examples = [
    ...
    // },
    {
      uri: 'webcam_face_landmark_detection_webgl',
      name: '(WebGL) Webcam Face Landmark Detection'
    },
    {
      uri: 'webcam_face_landmark_detection_cpu',
      name: '(CPU) Webcam Face Landmark Detection'
    },
    {
